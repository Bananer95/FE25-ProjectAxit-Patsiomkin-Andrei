...
// Собрать в массив всех актёров всех фильмов без повторения
...
const sortMovies = (movies: Array<IMovie>) => {
  ...
  const sortMovies = moviesArray.sort((a: number[], b: number[]) => {
    return b[1] - a[1];
  });
  return sortMovies;
};

// не правильно указан тип переменных в колбэке sort не могу понять какой нужно указать
